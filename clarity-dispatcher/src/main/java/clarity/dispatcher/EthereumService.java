...
import clarity.dispatcher.utils.JSONAble;
...
public class EthereumService implements JSONAble {
  ...
  public Map<String, Object> sendTransaction(
      String password, WalletFile wallet, BigDecimal amount, String toAddress) {
    ...
    TransactionReceipt receipt =
        Transfer.sendFunds(
                web3jService.getWeb3(), credentials, "0x" + toAddress, amount, Convert.Unit.ETHER)
            .sendAsync()
            .join();
